...
private:
  void initVRAndWindow() {
    ...
    window_ = glfwCreateWindow(WIDTH, HEIGHT, "Vulkan VR" , nullptr, nullptr);

    glfwSetWindowUserPointer(window_, this);
    glfwSetWindowSizeCallback(window_, VulkanVRApplication::onWindowResized);
  }
  ...
  std::vector<const char*> getRequiredExtensions() {
    ...
    //-----------------------------------------
    // Get the required extensions from OpenVR
    //-----------------------------------------
    if (!vr::VRCompositor()) {
